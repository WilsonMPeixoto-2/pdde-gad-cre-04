import { FileText, ExternalLink, Scale, Clock, AlertTriangle, BookOpen, Gavel, CalendarClock, Check, Ban, Info } from "lucide-react";
      ...
      <div className="section-card p-6 sm:p-8 mb-6 border-l-4 border-l-primary">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-left sm:text-justify leading-relaxed">
      ...
      <div className="section-card p-6 sm:p-8 mb-6 border-l-4 border-red-500 bg-gradient-to-r from-red-500/5 to-transparent">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed text-left sm:text-justify mb-3">
      ...
      <div className="section-card p-6 sm:p-8 mb-6">
        ...
        <div className="overflow-x-auto -mx-6 sm:mx-0 px-6 sm:px-0">
          <table className="table-institutional w-full text-sm">
            <thead>
              <tr>
                <th className="bg-primary text-primary-foreground rounded-tl-lg px-4 py-3 text-left">Tipo de Despesa</th>
                <th className="bg-primary text-primary-foreground rounded-tr-lg px-4 py-3 text-left">Documentos Aceitos</th>
              </tr>
            </thead>
            <tbody>
              {documentosComprobatorios.map((item, index) => (
                <tr key={index} className="border-b border-border/40">
                  <td className="font-medium px-4 py-3">{item.tipo}</td>
                  <td className="px-4 py-3">{item.documentos}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="section-card p-6 sm:p-8 mb-6">
        ...
        <div className="overflow-x-auto -mx-6 sm:mx-0 px-6 sm:px-0">
          <table className="table-institutional w-full text-sm">
            <thead>
              <tr>
                <th className="bg-primary text-primary-foreground rounded-tl-lg px-4 py-3 text-left">Regra</th>
                <th className="bg-primary text-primary-foreground w-36 text-center rounded-tr-lg px-4 py-3">Referência</th>
              </tr>
            </thead>
            <tbody>
              {regrasComprovantes.map((item, index) => (
                <tr key={index} className="border-b border-border/40">
                  <td className="px-4 py-3">{item.regra}</td>
      ...
      <div className="section-card p-6 sm:p-8 mb-6 border-l-4 border-blue-500 bg-gradient-to-r from-blue-500/5 to-transparent">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed text-left sm:text-justify mb-2">
        ...
        <div className="mb-8">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            ...
            <a
              ...
              className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-primary/10 to-primary/5 hover:from-primary/15 hover:to-primary/10 border-2 border-primary/40 hover:border-primary/60 transition-all duration-300 group"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-secondary to-secondary/50 hover:from-primary/10 hover:to-primary/5 border-2 border-border hover:border-primary/40 transition-all duration-300 group"
