...
const paragraphClass = "max-w-[70ch] text-base leading-[1.82] text-slate-800 dark:text-slate-200";
        ...
        <div className="editorial-spread">
          <div className="min-w-0">
            <AnimatedReveal delay={100} duration={700}>
              ...
              <h2
                className="mt-5 text-[2.55rem] font-bold text-foreground sm:text-[3.25rem] lg:text-[3.75rem]"
                style={{
                  lineHeight: "1.02",
            ...
            <AnimatedReveal delay={250} duration={800}>
              <div className="content-spacing mt-7 space-y-4 text-left">
                <p className={`drop-cap ${paragraphClass}`}>
                  ...
                  <strong className="font-semibold text-foreground"> estar ao lado das equipes gestoras, com orientação clara, apoio contínuo e diálogo.</strong>
                </p>
              ...
              <div className="mt-10 border-t border-slate-300 pt-6 dark:border-slate-700">
                ...
                <div className="mt-5 grid gap-6 md:grid-cols-2">
                  <div className="border-t border-slate-300 pt-4 dark:border-slate-700">
                    ...
                    <p className="mt-1 text-sm leading-7 text-slate-700 dark:text-slate-300">Coordenadora – E/4ª CRE</p>
                  </div>
                  <div className="border-t border-slate-300 pt-4 dark:border-slate-700">
                    <p className="font-semibold text-foreground">Bianca Barreto da Fonseca Coelho</p>
                    <p className="mt-1 text-sm leading-7 text-slate-700 dark:text-slate-300">Gerente – E/4ª CRE/GAD</p>
                  </div>
                </div>
              </div>
            </AnimatedReveal>
          ...
          <aside className="editorial-aside hidden lg:block" aria-label="Síntese institucional">
            <AnimatedReveal delay={300} duration={800}>
              ...
              <div className="mt-16 border-l border-slate-400 pl-4 dark:border-slate-600">
