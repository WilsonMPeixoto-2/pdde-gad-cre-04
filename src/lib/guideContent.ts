...
export const processFlowSteps: ProcessFlowStep[] = [
  ...
  },
  {
    ...
    number: 3,
    title: "Inclusão de Documentos Externos",
    description: "Registrar PDFs digitalizados e nato-digitais com nomes claros na árvore do processo.",
    sectionId: "secao-3",
  ...
  },
  {
    ...
    number: 4,
    title: "Autenticação de Documentos",
    description: "Autenticar os documentos digitalizados e manter a distinção entre assinatura e autenticação.",
    sectionId: "secao-4",
    sectionAnchor: "secao-4",
    icon: Shield,
    dependencies: ["inclusao"],
    criticalNote: "Documento digitalizado sem autenticação pode gerar exigência da GAD.",
    whatToDo: [
