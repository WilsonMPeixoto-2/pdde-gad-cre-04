        ...
        <main className="flex-1 lg:ml-0">
          ...
          <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="space-y-8">
              ...
              <AnimatedSection delay={100}>
                <SectionDivider number="2" title="Instrução Processual" subtitle="Documentos exigidos na prestação de contas do PDDE" icon={FileText} />
              </AnimatedSection>
              <AnimatedSection delay={150}>
                <SectionTwo />
              </AnimatedSection>
              ...
              <AnimatedSection delay={100}>
                <SectionDivider number="3" title="Inclusão de Documentos" subtitle="Anexar documentos externos ao processo no SEI!RIO" icon={Upload} />
              </AnimatedSection>
              <AnimatedSection delay={150}>
                <SectionThree />
              </AnimatedSection>
              ...
              <AnimatedSection delay={100}>
                <SectionDivider number="4" title="Declaração de Autenticidade" subtitle="Criação da declaração e procedimento de assinatura" icon={FileText} />
              </AnimatedSection>
              <AnimatedSection delay={150}>
                <SectionFour />
              </AnimatedSection>
              ...
              <AnimatedSection delay={100}>
                <SectionDivider number="5" title="Bloco de Assinatura" subtitle="Criação do bloco e disponibilização para assinatura do diretor" icon={CheckCircle} />
              </AnimatedSection>
              <AnimatedSection delay={150}>
                <SectionFive />
              </AnimatedSection>
              ...
              <AnimatedSection delay={100}>
                <SectionDivider number="6" title="Despacho e Finalização" subtitle="Despacho da GAD, publicação e relacionamento de processos" icon={Table2} />
              </AnimatedSection>
              <AnimatedSection delay={150}>
                {/* SectionSix - a ser criado no Sprint 2 */}
                <div id="secao-6" className="scroll-mt-20"></div>
              </AnimatedSection>
